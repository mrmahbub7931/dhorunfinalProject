        ...
        <div class="header_middle">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-3">
                        <div class="logo">
                            <a href="{{url('/')}}"><img src="{{asset('assets/front-end/img/logo/logo.jpg')}}" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-9">
                        ...
                        <div class="header_right_info">
                            ...
                            <div class="header_account_area">
                                ...
                                <div class="header_account-list  mini_cart_wrapper">
                                   <a href="javascript:void(0)"><i class="icon-shopping-bag"></i><span class="item_count">{{ Session::has('cart') ? Session::get('cart')->totalQty : "0" }}</span></a>
                                    @if (Session::has('cart'))
                                    @php
                                        $oldCart = Session::get('cart');
                                        $carts = new App\Cart($oldCart);
                                    ...
                                    <div class="mini_cart">
                                        <div class="cart_gallery">
                                            ...
                                            <div class="cart_item">
                                               <div class="cart_img">
                                                   <a href="{{route('frontend.product-details',$cart['item']['slug'])}}"><img src="{{$cart['item']['image_src']}}" alt=""></a>
                                               </div>
                                                <div class="cart_info">
                                                    
                                                    <a href="{{route('frontend.product-details',$cart['item']['slug'])}}">{{$cart['item']['product_name']}}</a>
        ...
        <div class="header_bottom sticky-header">
            <div class="container">  
                <div class="row align-items-center">
                    <div class="col-lg-3">
                        <div class="categories_menu">
                            ...
                            <div class="categories_menu_toggle">
                                ...
                                <li class="menu_item_children"><a href="{{$category['slug']}}">{{$category['parent_id'] === 0 ? $category['name'] : ""}} @if(count($category->children) > 0) <i class="fa fa-angle-right"></i>@endif</a>
                                        @if (count($category->children) > 0)
                                            
                                        <ul class="categories_mega_menu">
                                            @foreach ($category->children as $subCategory)
                                            <li class="menu_item_children"><a href="{{$subCategory['slug']}}">{{$subCategory['name']}}</a>
                                            </li>
                                            @endforeach
                                        </ul>
                                        @endif
                        ...
                        <div class="main_menu menu_position"> 
                            <nav>  
                                <ul>
                                    ...
                                    <li class="mega_items"><a href="javascript:void(0)">shop</a> 
                    ...
                    <div class="col-lg-3">
                        <div class="call-support">
                            <p>Call Support: <a href="tel:(+880)1824373099">(+880) 1824373099</a></p>
                        </div>
                    </div>
                </div>
            </div>
